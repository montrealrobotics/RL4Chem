...
class reinvent_optimizer(BaseOptimizer):
    ...
    def update(self, obs, rewards, old_logprobs, prior_logprobs, nonterms, episode_lens, cfg, metrics, log):
        with torch.no_grad():
            ir_logratio = prior_logprobs - old_logprobs
            rewards = rewards - cfg.kl_coef * (ir_logratio ** 2)
    ...
    def optimize(self, cfg):
        ...
        while eval_strings < cfg.max_strings:
            ...
            with torch.no_grad():
                ...
                obs, rewards, nonterms, old_logprobs, prior_logprobs, episode_lens = self.agent.get_data_with_prior(self.prior, cfg.batch_size, cfg.max_len, self.device)
            ...
            self.update(obs, rewards, old_logprobs, prior_logprobs, nonterms, episode_lens, cfg, metrics, log)

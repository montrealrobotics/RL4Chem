...
python char_rnn.py target=PARP1 max_grad_norm=0.5 seed=$SLURM_ARRAY_TASK_ID wandb_log=True string_rep=smiles wandb_run_name=0drop_smiles_charnn_$SLURM_ARRAY_TASK_ID"
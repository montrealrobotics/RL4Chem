...
python char_conv.py target=KIT max_grad_norm=0.5 seed=$SLURM_ARRAY_TASK_ID wandb_log=True string_rep=smiles wandb_run_name=0drop_smiles_chaconv_$SLURM_ARRAY_TASK_ID"
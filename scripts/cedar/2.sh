...
python train_reinforce_trans_agent.py target=${t} seed=${s} rep=selfies dataset=zinc10m wandb_log=True wandb_run_name='reinforce_zinc10m_char_trans_selfies_'${s}

...
python train_reinvent_reg_agent.py target=${t} seed=${s} reg=ent ent_coef=0.005 wandb_log=True reg=ent wandb_run_name='entreg0.005_reinvent_char_trans_smiles_'${s}

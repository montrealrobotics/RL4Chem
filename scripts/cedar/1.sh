...
rsync -a $HOME/projects/def-gberseth/$USER/RL4Chem/ $SLURM_TMPDIR/RL4Chem --exclude=env_crl
...
python train.py target=${array[SLURM_ARRAY_TASK_ID]} max_selfie_length=22 wandb_log=True wandb_run_name=dqn_ln_max_len_22 seed=1 num_sub_proc=20" 
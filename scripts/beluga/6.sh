...
wandb offline
python train_reinforce_agent.py target=${t} seed=${s} rep=selfies wandb_log=True learning_rate=0.00005 wandb_run_name='lr0.00005_reinforce_char_rnn_selfies_'${s}

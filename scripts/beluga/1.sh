...
wandb offline
python train_reinforce_rnn_agent.py target=${t} seed=${s} learning_rate=0.000001 wandb_log=True wandb_dir='./' wandb_run_name='lr_0.000001_reinforce_char_trans_smiles_'${s}

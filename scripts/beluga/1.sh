...
python train_reinforce_fc_agent.py target=${t} seed=${s} wandb_log=True wandb_dir='.' wandb_run_name='reinforce_char_fc_smiles_'${s} &

python train_reinforce_fc_agent.py target=${t} seed=${s} rep=selfies wandb_log=True wandb_dir='.' wandb_run_name='reinforce_char_fc_selfies_'${s}

...
wandb offline
python train_reinforce_trans_agent.py target=${t} seed=${s} learning_rate=0.00005 wandb_log=True wandb_dir='./' wandb_run_name='lr_0.00005_reinforce_char_trans_smiles_'${s}
